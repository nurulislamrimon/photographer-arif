...
const Gallery = () => {
    ...
    return (
        <section className='my-8'>
            <div className=' bg-[url(https://scontent.fcgp4-1.fna.fbcdn.net/v/t39.30808-6/306539008_3292793961004209_6374030496542470897_n.jpg?stp=dst-jpg_p180x540&_nc_cat=100&ccb=1-7&_nc_sid=8bfeb9&_nc_eui2=AeE7s7DB8n5WccdgER-182aT6GG-dzPLRQPoYb53M8tFA5LVjqTtMGhpMRILRqGmJbaxV7lEvnD9p1h_Bm0R7x0-&_nc_ohc=ARn8NLMNrksAX-sZTSX&_nc_zt=23&_nc_ht=scontent.fcgp4-1.fna&oh=00_AT82ac-EtR5WMjFkEFKa2fkN09hdVzONaOaYQ6toOghl8g&oe=63336D79)] bg-fixed bg-no-repeat h-[50vh] lg:h-[calc(100vh-50px)] bg-cover'>
