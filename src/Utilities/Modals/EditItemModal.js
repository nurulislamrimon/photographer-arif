      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          <form
            ...
            className="grid gap-5  mx-auto py-20"
          >
            ...
            <button className="btn" disabled={handleDisable}>
              Submit
            </button>
          </form>
          ...
          <label
            ...
            className="btn btn-circle bg-black absolute top-3 lg:top-12 right-3"
          >
            X
          </label>
        </div>
